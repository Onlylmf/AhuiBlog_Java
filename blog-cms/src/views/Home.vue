<template>
	<el-container class="home-container">
		<!--头部-->
		<el-header style="background-color: #FFB396">
			<div class="title">
				<img src="~assets/img/logoNav.gif" alt="" height="60">
				<span>Ahui'Blog 博客后台管理</span>
			</div>
		...
		<el-container>
			<!--侧边栏-->
			<el-aside style="background-color: #949CDF" :width="isCollapse? '64px' : '190px'">
				<div class="toggle-button" @click="isCollapse=!isCollapse"><i :class="isCollapse?'el-icon-s-unfold':'el-icon-s-fold'"></i></div>
				<!--菜单-->
				<el-menu background-color="#FFE5B9" text-color="#f58634" active-text-color="#949CDF" :default-openeds="defaultOpeneds"
...
<style scoped>
	...
	.el-main::-webkit-scrollbar-thumb {
		-webkit-box-shadow: inset 0 0 6px #FFC074;
		box-shadow: inset 0 0 6px #FFC074;
