<template>
	...
	<div class="form">
		...
		<el-form :inline="true" :model="commentForm" :rules="formRules" ref="formRef" size="small">
			<el-input :class="'textarea'" type="textarea" :rows="5" v-model="commentForm.content" placeholder="叫朕父皇~"
			          maxlength="250" show-word-limit :validate-event="false" id="contentImg"></el-input>
...
<style>
  ...
  #contentImg{
    background: url("https://gitee.com/Onlylmf/image/raw/master/Sitich/xgl.gif") 100% 100% no-repeat;
  }
</style>